...
[`TaskDetailFormatter`][archcare.core.formatter.TaskDetailFormatter] port; a GUI frontend would
supply its own implementations and reuse `core/`, `config/`, and `services/` unmodified.
