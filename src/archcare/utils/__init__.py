...
This package defines the system/OS boundary of Archcare. It acts as the utility
and hardware-query layer of the application, orchestrating low-level system calls,
parsing raw OS output, and formatting CLI presentations.
...
Public API:
    ...
    - `get_memory_info`: Get comprehensive system memory information including virtual
        and swap memory.
    - `backup_file`: Create a timestamped backup of a file using sudo to ensure proper permissions.
    ...
    - `configure_console`: Configure the global console instance for interactive or silent modes.
