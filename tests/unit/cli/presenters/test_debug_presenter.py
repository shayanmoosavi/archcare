...
class TestDebugPresenter:
    ...
    def test_render_test_notification_includes_severity(self, mocker):
    ...
    def test_invalid_severity_includes_severity_and_valid_options(self, mocker):
    ...
    def test_notification_unavailable_mentions_libnotify_install(self, mocker):
    ...
    def test_notification_send_failure_points_to_logs(self, mocker):
        mocker.patch(f"{_MODULE}.print_error")
        mock_info: MagicMock = mocker.patch(f"{_MODULE}.print_info")
